from app import app, db, BusinessProfile
from werkzeug.security import generate_password_hash

# Configuración del Dueño
MI_TELEFONO = "+34630339601" # Ajusta si es necesario
...
def seed():
    with app.app_context():
        ...
        # 1. Crear Tablas (Si no existen en Postgres)
        ...
        if not existing_user:
            ...
            print("ℹ️  El usuario ya existe. No se realizaron cambios.")
