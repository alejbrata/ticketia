...
class AgentExecutor:
    ...
    """
    def __init__(self, user_message, phone_number, business_profile, media_url=None, mail_service=None, channel='whatsapp'):
    ...
    def execute(self):
        try:
            ...
            print(f"Error Agente Executor: {e}")
        ...
        for tool_call in tool_calls:
            ...
            if function_name == "check_availability":
                ...
                if tool_output.startswith("⏳"): 
                    # Early return to avoid blocking
                ...
                resp_text, media_url = agent.handle_inquiry(self.phone_number, last_user_msg, self.business_profile, channel=self.channel)
...
def run_agent(user_message, phone_number, business_profile, media_url=None, mail_service=None, channel='whatsapp'):
    ...
    """
    executor = AgentExecutor(user_message, phone_number, business_profile, media_url, mail_service, channel)
